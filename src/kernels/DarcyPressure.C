...
registerMooseObject("tut1App", DarcyPressure);
...
DarcyPressure::validParams()
{
  ...
  params.addParam<Real>("viscosity", 7.89e-04, "The dynamic viscosity ($\\mu$) of the fluid, the default value is that of water at"
  "30 degrees Celcius (7.98e-04 Pa-s).");
